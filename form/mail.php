...
$allowedOrigins = [
    'https://www.clairvoyancecorp.com',
    'https://testup.clairvoyancecorp.com',
    'https://msclinic.clinic',
    'https://ms-clinic.clinic',
    'https://seiyukai-msclinic.com'
];
...
$subjectTemplates = [
    'reservation' => [
        ...
        'admin' => '【MSクリニック】{{media}}からのご来院予約について',
    ],
    'consultation' => [
        'user' => $_ENV['SUBJECT_CONSULTATION'],
        'admin' => '【MSクリニック】{{media}}からの相談について',
    ],
];
