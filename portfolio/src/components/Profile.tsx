      ...
      <div className='w-11/12 max-w-3xl mx-auto bg-white rounded-2xl shadow-md p-8'>
        ...
        <dl className='grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-6 text-gray-700'>
          <div>
            ...
            <dd className='mt-1 text-lg'>チピー</dd>
          </div>
          <div>
          ...
          <div>
            <dt className='font-semibold text-purple-500'>生まれ年</dt>
            <dd className='mt-1 text-lg'>1998年</dd>
          </div>
          <div>
            <dt className='font-semibold text-purple-500'>出身地</dt>
            <dd className='mt-1 text-lg'>埼玉県</dd>
          </div>
          <div>
            <dt className='font-semibold text-purple-500'>趣味</dt>
            <dd className='mt-1 text-lg'>パン屋さん・ブルワリー巡り</dd>
          </div>
          <div>
